...
def create_parser():
    ...
    parser.add_argument('--testing', action='store_true',help='Do to perform testinf evaluation')
    # CPU/GPU
   ...
   #parser.add_argument('--dataset', type=str, default='radiant_earth/pa', help='Data set directory')    
    ...
    parser.add_argument('--nclasses', type=int, default=10, help='Number of classes in maxpool output')    
    ...
    parser.add_argument('--dropout_dense', type=float, default=.1, help='Dropout rate')
...
def generate_fname(args, params_str):
    ...
    return "%s/%s%s_%s%s%s_%s%s_%s%s_%s%s"%(args.results_path,
                                        experiment_type_str, label_str,
                                        conv_str,conv_size_str, conv_filter_str,
                                        dense_str, dense_size_str,
                                        dropout_str, dropoutS_str, 
                                        regularizer_l2_str,                                                                           
                                        lrate_str)
    '''
